...
## Current Goal
We are building the **Address Eligibility Search**—the first module where a user enters an address and the swarm tells them exactly what permits they need.