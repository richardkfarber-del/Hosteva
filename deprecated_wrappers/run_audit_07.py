...
Audit the following Phase 07 artifacts:

{read_artifact("07_shadow_ops_artifact.md")}''', system_prompt=load_prompt('agent_coulson_rules.md'), llm_config=local_config, tools=io_tools)
