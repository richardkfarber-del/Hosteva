...
dev_artifact = read_file_safe('/home/rdogen/OpenClaw_Factory/projects/Hosteva/05_development_artifact.md')

coulson_prompt = f"""Audit Phase 05 artifacts. YOU MUST READ THE TEST LOGS AND CODE. DO NOT BLINDLY APPEND SUCCESS. If tests failed or the code is invalid, you MUST output FAIL followed by the exact error message.

=== PHASE 5 DEVELOPMENT ARTIFACT ===
{dev_artifact}
"""

workflow = Workflow('Audit_05')
coulson = Node.agent(
    name='Agent Coulson', 
    prompt=coulson_prompt, 
