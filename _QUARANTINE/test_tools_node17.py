from graphbit import init, LlmConfig, Workflow, Executor, Node, tool, execute_production_tool_calls, execute_workflow_tool_calls
import subprocess
import json
...
try:
    # Pass the function reference to execute_workflow_tool_calls
