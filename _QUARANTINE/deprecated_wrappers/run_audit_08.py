...
Audit the following Phase 08 artifacts:

{read_artifact("08_retrospective_artifact.md")}''', system_prompt=load_prompt('agent_coulson_rules.md'), llm_config=local_config, tools=io_tools)
