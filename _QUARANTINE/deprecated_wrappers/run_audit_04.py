...
Audit the following Phase 04 artifacts:

{read_artifact("04_environment_artifact.md")}''', system_prompt=load_prompt('agent_coulson_rules.md'), llm_config=local_config, tools=io_tools)
