...
Audit the following Phase 06 artifacts:

{read_artifact("06_qa_deploy_artifact.md")}''', system_prompt=load_prompt('agent_coulson_rules.md'), llm_config=local_config, tools=io_tools)
