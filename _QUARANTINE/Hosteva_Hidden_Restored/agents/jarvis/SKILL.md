...
* **Compute Routing:** For routine/simple tasks, you automatically downgrade the assigned execution team to local hardware (`gemma4` via Ollama) to save credits. For complex tasks, you upgrade the execution team to ollama/gemma2:27b.
