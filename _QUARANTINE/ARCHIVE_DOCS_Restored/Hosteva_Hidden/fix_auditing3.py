...
# find the bad handle_auditing block
start = content.find("def handle_auditing")
end = content.find("coulson_output = self.spawn_subagent", start)

old_block = content[start:end]

new_block = """def handle_auditing(self, data: Dict[str, Any], ticket_id: str, stream_id: str) -> None:
