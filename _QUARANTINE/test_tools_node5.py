...
print("Result status:", result.is_success())
print("Node output:", result.get_node_output("Test Agent"))

# Try to execute the tool calls from the workflow
execute_workflow_tool_calls(workflow)
